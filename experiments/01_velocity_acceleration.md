...
$${\rm acceleration = (75~mph-65~mph)/(1/120~hr) = 1200~mi/hr.}$$

Here we expressed 30 seconds as 1/120 of an hour. What the average acceleration means is that, if you kept on accelerating like that for one hour your speed would in crease by 1200 mph. (Not possible but fun to think about.) If you slow down, and make a similar calculation of the acceleration, you get a negative number. Accelerations can correspond to slowing down and are sometimes called decelerations. Just as with velocity, you can also measure an instantaneous acceleration (though the measurement is a little trickier) that corresponds to the average acceleration over an extremely small time interval.
...
* 1 low friction cart with motion sensing
* 1 aluminum track
* 1 length of string
* 1 mass of 50-100 grams
* 1 computer with Pasco Capstone

## Predictions/Preliminary Questions

1. What does it mean if an object moves with a *constant velocity*? Sketch a graph of velocity vs. time for a car moving with a constant velocity. Put velocity on the vertical axis, and time on the horizontal axis of your graph.
...
1. Place one of the metal tracks on your lab table and place the cart on the track. Lightly push the cart and observe its motion after you stop pushing. The cart should move at constant velocity on the aluminum track. Do you think it does? Why or why not?
2. Now, you'll use the spring on the cart to push it. This should give the cart the same speed each time. It is often useful to make approximate measurements without using complicated equipment. For example, use your forearm as a unit of distance and count seconds by counting one-thousand-one, one-thousand-two, etc. Then you might measure, with your arm, (don't use a meter stick) three arm lengths along the aluminum track. Let the car run that three arm length distance and measure the time by counting – one‐thousand‐one, etc. To determine the speed, divide three arm lengths by the time in seconds and obtain the speed in terms of arm‐lengths per second. Each person in the group should try this approach at least once.
3. Take some measurements with the ruler on the track and a stopwatch on your phone to calculate the approximate speed of the cart. Explain how you determined its speed (or velocity). Be sure to record the units you are using for each value.
...
**Exploration with Capstone software** *For instructions about using the Capstone data collection software or Motion sensor, refer to [Appendix A](#appA).*

On the computer desktop open the Capstone software with the motion detector connected. If you have problems, check your connections and inform your TA.

To collect data you press the Record button. Practice collecting data of the cart pushed by its spring. Make certain everyone in your group has a chance to operate the computer. You can adjust the settings in Capstone to graph position vs. time, velocity vs. time and/or acceleration vs. time. Please read the appendix on using Capstone and take time during lab to make sure you can create all graphs necessary.

If possible, every member of your group should operate the computer.

### Analysis

1. From the graph of distance vs. time, calculate the slope of the line. How is this slope related to the velocity of the car? Capstone allows you to fit curves automatically. Your instructor or TA will help you with this.
...
Use a low friction PASCO cart. Raise one end of the aluminum track to make the incline by adjusting the feet at one end of the track. You only need a slight incline. **Be careful not to let the cart fall off the track. They are quite expensive!**
...
Discuss with your partners and make a prediction: How would you expect a position vs. time and a velocity vs. time graph to look for a cart rolling down an incline? Draw a sketch of the graph. Explain what coordinate system you are using

### Exploration

1. Use the track ruler and a stopwatch to determine the average velocity of the cart rolling down the incline.
...
Use the computer to obtain graphs of distance vs. time and velocity vs. time for the cart on the incline. Refer to the proper appendix or ask your instructor if you need assistance using the software, interface or sensor.
...
1. Did the cart have a constant velocity?
